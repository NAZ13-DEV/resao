...
const Minimal = () => {
    return (
        <div>
            ...
            {/*Banner*/}
            <div>
                <div className="relative bg-cover bg-center bg-gray-800 h-screen flex items-center" style={{ backgroundImage: "url('/images/bg/1920x1080.svg')", backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative' }}>
