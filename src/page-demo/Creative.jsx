...
const Creative = () => {
    return (
        <div>
            ...
            {/*Banner*/}
            <div className="relative bg-cover bg-center bg-gray-800 h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] xl:h-[800px] flex items-center" style={{ backgroundImage: "url('/images/bg/1920x1080.svg')", backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative' }}>
