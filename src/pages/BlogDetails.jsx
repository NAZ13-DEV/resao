        ...
        <>
            ...
            <div className=''>
                ...
                <div className="h-[600px] text-white text-center grid bg-cover" style={{
                    backgroundImage: `url(/images/about/1920x600.svg)`,
                }}>
                ...
                <div className='container mx-auto'>
                    <div className={`${props.animate ? 'wow animate__fadeIn' : ''}`} data-wow-duration="3s">
                        <div className="py-8 px-0 md:px-12 lg:px-24 xl:px-40 flex justify-center">
                            <img src="/images/blog/1200x300.svg" alt="Blog Details Images" className='w-full h-[300px] object-cover' />
                        </div>
                    ...
                    <div className={`py-8 flex justify-center relative ${props.animate ? 'wow animate__fadeIn' : ''}`} data-wow-duration="3s">
                        <img src="/images/blog/1920x600.svg" alt="Blog Images" className='z-10 w-full h-[400px] object-cover' />
                        <ModalVideo channel='youtube' autoplay isOpen={isOpen} videoId="OA1oYZxKSlg" onClose={() => setOpen(false)} />
