...
const social = [
    { social: <BsFacebook />, link: '#' },
    { social: <BsDribbble />, link: '#' },
    { social: <BsInstagram />, link: '#' },
    { social: <BsTwitterX />, link: '#' },
    { social: <BsGithub />, link: '#' },
]
        ...
        <div className="bg-[#2c2e36] text-gray-400">
            ...
            <div className="text-white bg-[#26262e]">
                <div className="p-4 text-sm md:flex md:items-center md:justify-center">
                    <h2 className='text-gray-400 text-md text-center'>Copyright © 2024 Kccthemes. All Rights Reserved.</h2>
                </div>
            </div>
        </div>
    )
